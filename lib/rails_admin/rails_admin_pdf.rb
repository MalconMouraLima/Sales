  ...
  module Config
    module Actions
      class Pdf < Base
        ...
        # Para não chamar 2x a custom action
        ...
        register_instance_option :controller do
          Proc.new do
            ...
            File.open("public/agreement.pdf", 'r') do |f|
              send_data f.read.force_encoding('BINARY'), :filename => 'agreement.pdf', :type => "application/pdf", :disposition => "attachment"
            end
            File.delete("public/agreement.pdf")
